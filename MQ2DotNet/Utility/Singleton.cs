...
{
    // https://github.com/StephenCleary/CrossDomainSingleton/blob/master/Source/DomainAwareSingleton/Singleton.cs
    /// <summary>
    ...
    internal static class Singleton<T> where T : MarshalByRefObject, new()
    {
        /// <summary>
